...
public class NonogramScreen{
	JFrame screen;
	JPanel screenGrid, toggleMode, hintsX, hintsY;
	JButton checkButton;
	NonogramGrid g;
	Game game;
    ...
    private void setUp() {
        ...
        this.screen.add(this.screenGrid, 1);
        
        this.checkButton = new checkButton(g);
        this.screen.add(this.checkButton, 2);
      
        this.hintsX = new NonogramScreenHintsX(g);
        this.screen.add(this.hintsX, 3);
        
        this.hintsY = new NonogramScreenHintsY(g);
        this.screen.add(this.hintsY, 3);
	...
	public class checkButton extends JButton{
		...
		public class mouse extends MouseFiller{
			public void mouseClicked(MouseEvent e) {
				...
				for (boolean b: g.colStatus) {
					System.out.println(b);
				}
				System.out.println("Rows");
				for (boolean b: g.rowStatus) {
					System.out.println(b);
				}
			}
		}
